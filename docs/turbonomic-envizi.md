...
The below errors are found in the App Connect logs.
 ...
 Your Amazon S3 account doesn't have the required permissions to complete the isObjectPresent action on the object object: 403 "Forbidden"|Invalid customer|Configure the customer name in set variable exactly as provided by Envizi# Turbonomic - Envizi Integration
